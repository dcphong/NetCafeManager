 ...
 * @author ASUS
 */
public class ChiiTietHoaDonJDialog extends javax.swing.JDialog {
     ...
     */
    public ChiiTietHoaDonJDialog(java.awt.Frame parent, boolean modal, int InvoiceID) {
    ...
    private void loadDataToArray(){
        try {
            ...
            Logger.getLogger(ChiiTietHoaDonJDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void fillToTable(){
        ...
        for (InvoiceDetail listInvoiceDetail : listInvoiceDetails) {
            try {
                product = productDAO.selectByID(invoiceDetail.getProductID());
            } catch (Exception ex) {
                Logger.getLogger(ChiiTietHoaDonJDialog.class.getName()).log(Level.SEVERE, null, ex);
            }
            Object[] row = {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChiiTietHoaDonJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChiiTietHoaDonJDialog dialog = new ChiiTietHoaDonJDialog(new javax.swing.JFrame(), true, 1);
