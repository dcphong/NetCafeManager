...
public class HoaDonChiTietJDialog extends javax.swing.JDialog {
    ...
    DefaultTableModel modelInvoiceDetail;
    DefaultTableModel modelSession;
    
    /**
     * Creates new form HoaDonChiTietJDialog
     */
    public HoaDonChiTietJDialog(java.awt.Frame parent, boolean modal, int InvoiceID) {
    ...
    public void initTable() {
        ...
        JTableHeader tableHeader = tblInvoiceDetali.getTableHeader();
    ...
    private void loadDataToArray(){
        try {
            ...
            Logger.getLogger(HoaDonChiTietJDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HoaDonChiTietJDialog dialog = new HoaDonChiTietJDialog(new javax.swing.JFrame(), true, 1);
